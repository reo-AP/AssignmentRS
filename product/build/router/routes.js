...
var ProductRoutes = /** @class */ (function () {
    ...
    ProductRoutes.prototype.register = function (server) {
        return __awaiter(this, void 0, void 0, function () {
            var productModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (new product_model_1.default().createModel())];
                    case 1:
                        productModel = _a.sent();
                        return [2 /*return*/, new Promise(function (resolve) {
                                logger_1.logger.info('ProductRoutes - Start adding product routes');
                                var controller = new product_controller_1.default(productModel);
                                server.route({
                                    method: 'GET',
                                    path: '/products',
                                ...
                                logger_1.logger.info('ProductRoutes - Finish adding product routes');
                                resolve(1);
                            })];
                }
            });
